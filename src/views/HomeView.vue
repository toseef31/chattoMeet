     		 	  ...
     		 	  <div class="form-row">
     		 	   ...
     		 	   <p class="text-muted text-start" style="font-size:14px">Getting Started in easy, Enter detail givin below</p>
     		 	    <div class="form-group col-md-12 mt-4 mb-4">
     		 	      <input type="password" class="form-control" id="inputPassword4" placeholder="+ 80-1234-5678">
     		 	    </div>
     		 	  </div>
     		 	  
     		 	  <button type="submit" class="btn btn-success d-grid w-100 mt-3 border-0 rounded py-2" style="background-color:black">Create Meeting</button>
     		 	</form>
     		 </div>
     	</div>
     </div></div>
